...
router.get('/',function(req, res, next) {
    req.getConnection(function(err,connection){
        var query = connection.query('SELECT * FROM customer',function(err,rows)
        {
            ...
            res.render('customer/list',{title:"datasekolah",data:rows,session_store:
            req.session});
        });
...
router.post('/add',function(req, res, next)
{
 ...
 req.flash('msg_info', 'Create datasekolah success');
 res.redirect('/datasekolah');
 }
 });
 });
 }else{
...
10
 ...
 req.flash('msg_info', 'Update datasekolah success');
 res.redirect('/datasekolah/edit/'+req.params.id);
 }
 });
 });
 }else{
 ...
 router.delete('/delete/(:id)', function(req
, res, next) {
 req.getConnection(function(err,connection){
 var customer = {
 id: req.params.id,
 ...
 req.flash('msg_info', 'Delete datasekolah Success');
 res.redirect('/datasekolah');
 }
 });
 });
